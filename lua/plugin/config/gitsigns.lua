return function()
  require("gitsigns").setup({
    ...
    on_attach = function(bufnr)
      ...
      end, { desc = "Gitsigns visual stage hunk" })
      map("v", "<leader>hr", function()
        gs.reset_hunk({ vim.fn.line("."), vim.fn.line("v") })
      end, { desc = "Gitsigns visual reset hunk" })
      ...
      map("n", "<leader>hd", gs.diffthis, { desc = "Gitsigns diffhis" })
      ...
      -- Text object
      map({ "o", "x" }, "ih", ":<C-U>Gitsigns select_hunk<CR>", { desc = "Gitsigns text object seect hunk" })
    end,
  })
end
